                ...
                <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-slate-900/80 backdrop-blur-md transition-all duration-300">
                    <div className="relative flex flex-col items-center">
                        <div className="relative flex h-24 w-24 mb-8">
                            ...
                            <span className="relative inline-flex rounded-full h-24 w-24 bg-gradient-to-tr from-green-600 to-green-500 shadow-2xl shadow-green-500/40 items-center justify-center border border-green-400/20">
